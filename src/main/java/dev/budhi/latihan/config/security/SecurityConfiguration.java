package dev.budhi.latihan.config.security;
...
import static dev.budhi.latihan.modules.users.Role.*;
import static dev.budhi.latihan.modules.users.Permission.*;
...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // active authorize level method
        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL).permitAll()
                                ...
                                // note: authorize level spring security config
